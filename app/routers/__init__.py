...
# 注册各个子路由
warehouse_router.include_router(health_router, tags=["health"])  # 注册到 /api/v1/warehouse/
warehouse_router.include_router(health_router, prefix="/health", tags=["health"])  # 注册到 /api/v1/warehouse/health
